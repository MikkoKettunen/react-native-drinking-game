  ...
  _renderItem = ({ item }) => {
    return (
      <View style={styles.sliderContainer}>
        ...
        <Image style={styles.gifImage} source={item.image} />
      </View>
    );
  };
  _onDone = () => {
                      ...
                      [
...

                        {
                          ...
                          onPress: () => {
                            ...
                            this.setState({ A: value.replace(/['"]+/g, "") });
                            this.onSubmitA();
                            this.hideButton();
                          },
                        },
                      ...
                      [
...

                        {
                          ...
                          onPress: () => {
                            ...
                            this.setState({ J: value.replace(/['"]+/g, "") });
                            this.onSubmit11();
                            this.hideButton();
                          },
                        },
                      ...
                      [
...

                        {
                          ...
                          onPress: () => {
                            ...
                            this.setState({ Q: value.replace(/['"]+/g, "") });
                            this.onSubmit12();
                            this.hideButton();
                          },
                        },
                      ...
                      [
...

                        {
                          ...
                          onPress: () => {
                            ...
                            this.setState({ K: value.replace(/['"]+/g, "") });
                            this.onSubmit13();
                            this.hideButton();
                          },
                        },
...
const slides = [
  ...
  {
    key: "somethun-dos",
    title: "Sääntöjen vaihtaminen",
    text: "Other cool stuff",
    image: require("../assets/gif4.gif"),
    backgroundColor: "#38B743",
  },
];
